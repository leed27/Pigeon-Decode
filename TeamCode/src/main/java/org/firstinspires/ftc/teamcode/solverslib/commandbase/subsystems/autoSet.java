...
//
//        double howFarInRed = Math.sqrt(Math.pow(((144-y)/(12)), 2) + Math.pow(((144-x)/(12)),2));
//        double howFarInBlue = Math.sqrt(Math.pow(((144-y)/(12)), 2) + Math.pow(((-x)/(12)),2));
...
//            newAngle = Math.toDegrees(Math.atan2((144-y), -x));
//        }
//
