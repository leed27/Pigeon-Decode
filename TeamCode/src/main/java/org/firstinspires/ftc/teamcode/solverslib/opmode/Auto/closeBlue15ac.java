...
public class closeBlue15ac {
    ...
    public PathChain openGateAgain, shootGateAgain;
    ...
    public void generatePaths(Follower follower) {
        ...
        openGateAgain = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(59, 75),
                                new Pose(32.579, 42.470),
                                new Pose(9.873, 59.851)
        ...
        shootGateAgain = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(9.873, 59.851),
