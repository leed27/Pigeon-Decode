...
@TeleOp(name = "TURRET TIME!")
public class TurretTime extends CommandOpMode {
    ...
    public void initialize(){
        ...
        driver.getGamepadButton(GamepadKeys.Button.DPAD_LEFT).whenReleased(
                new ParallelCommandGroup(
                    new InstantCommand(() -> turretTime.setPosition(turretPose-0.05)),
        ...
        driver.getGamepadButton(GamepadKeys.Button.TRIANGLE).whenReleased(
                new InstantCommand(() -> hoodyServo.setPosition(0.3))
